...
Renaming the cleaned segmentation files and meshing them via ITK --> <br>[mesh_loop-mod_sbatch.sh](https://github.com/Chhoa/Brain-Segmentation-Project/blob/main/mesh_loop-mod_sbatch.sh), source code: [mesh3d.cpp](https://github.com/Chhoa/Brain-Segmentation-Project/blob/main/mesh3d.cpp)
