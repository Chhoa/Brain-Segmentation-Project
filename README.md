...
[mesh_loop-mod.sh](https://github.com/Chhoa/Brain-Segmentation-Project/blob/main/mesh_loop-mod.sh), source code: [mesh3d.cpp](https://github.com/Chhoa/Brain-Segmentation-Project/blob/main/mesh3d.cpp)
